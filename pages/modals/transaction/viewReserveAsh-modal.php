<!----------------------------------------------Reserve FORM---------------------------------->
<div class='modal fade' id='<?php echo"viewReserveAsh$intUnitID";?>' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' style='z-index: 1500;display:none;'>
    <div class='modal-dialog' role='document' style = 'width:80%; height: 90%;'>
        <div class='modal-content'>
            ...
            <div class='modal-body'>
                <form class='form-horizontal' role='form' target='_blank' action='../modals/transaction/reservationAsh-pdf.php' method='GET'>
                            ...
                            <div class ='panel panel-default'>
                                <div class='panel-body'>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-5'>
                                            <?php
                                                $sql3="SELECT c.intCustomerId, c.strFirstName, c.strMiddleName, c.strLastName, c.strAddress, a.intAvailUnitAshId, a.dateAvailUnit, a.strModeOfPayment, a.deciAmountPaid, a.intStatus, a.intInterestId, a.deciDownpayment, a.datDueDate, i.intNoOfYear, i.deciRegularInterest FROM tblcustomer c
                    ...
                    <form class='form-horizontal' role='form' action='availUnit.php' method='POST'>
                            ...
                            <button class = 'btn btn-danger col-md-12' type='submit' name = 'btnCancelReservationAsh'>Cancel Reservation</button>
                    </form>
