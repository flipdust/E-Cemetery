...
$sql = "SELECT * FROM tblcustomer c INNER JOIN tblavailunitash a ON a.intCustomerId = c.intCustomerId INNER JOIN tblinterest i ON a.intInterestId = i.intInterestId INNER JOIN tblacunit l ON a.intUnitID = l.intUnitID INNER JOIN tbllevelash la ON la.intLevelAshID = l.intLevelAshID INNER JOIN tblashcrypt ac ON ac.intAshID = la.intAshID INNER JOIN tbldownpaymentash da ON da.intAvailUnitAshId = a.intAvailUnitAshId where a.intAvailUnitAshId='".$intUnitId."'";
...
$pdf -> Cell(120,0,'Downpayment Receipt',0,0,'C');
$pdf -> Ln(15);
...
$pdf -> SetFont('Arial', 'B', 12);
$pdf -> SetX(20);
$pdf -> Cell(0,0,'Ash Information: ',0,0,'L');
$pdf -> SetFont('Arial', 'B', 12);
$pdf -> SetX(60);
...
$pdf -> SetFont('Arial', '', 12);
$pdf -> SetX(60);
$pdf -> Cell(130,0,$strModeOfPayment,0,0,'R'); //palitan ng variable
$pdf -> Ln(15);
$pdf -> SetX(70);
$pdf -> SetFont('Arial', 'B', 12);
