<!----------------------------------------------Reserve FORM---------------------------------->
<div class='modal fade' id='<?php echo"modalAtneed$intLotID";?>' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' style='z-index: 1500;display:none;'>
            ...
            <div class='modal-body'>
                <form class='form-horizontal' role='form' action='availUnit.php' method='POST'>
                            ...
                            <div class ='panel panel-default'>
                                <div class='panel-body'>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-5'>
                                            <input type='text' class='form-control input-md' value='At-Need' name='tfModeOfPayment' readonly>
                                        </div>
                                    </div>
                                            ...
                                            <select class='form-control' name = 'selectYear' required>
                                                ...
                                                <?php
                                                    ...
                                                    while($row6 = mysql_fetch_array($result6)){
                                                        ...
                                                        echo"<option value='$intInterestId'>$intNoOfYear - $deciAtNeedInterest %</option>";
                                            ...
                                            <div class=' input-group'>
                                                 <?php
                                                    ...
                                                    while($row7 = mysql_fetch_array($result7)){
                                                        ...
                                                        $downpayment=$deciSellingPrice*$finalDependencyValue;
                    ...
                    <div class='form-group modal-footer'>
                        <?php
                            $balance = $deciSellingPrice - $downpayment;
                         ?> 
                        <input type='hidden' name='tfBalance' value='<?php echo"$balance"; ?>'>  
                        <button type='submit' class='btn btn-success' name= 'btnSubmitAtNeed'>Submit</button>
