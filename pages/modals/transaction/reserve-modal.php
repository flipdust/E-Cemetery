<!----------------------------------------------Reserve FORM---------------------------------->
<div class='modal fade' id='<?php echo"modalReserve$intLotID";?>' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' style='z-index: 1500;display:none;'>
            ...
            <div class='modal-body'>
                <form class='form-horizontal' role='form' action='availUnit.php' method='POST'>
                    ...
                    <div class='form-group modal-footer'>
                        ...
                        <button type='submit' class='btn btn-success' name= 'btnSubmitReserve'>Submit</button>
