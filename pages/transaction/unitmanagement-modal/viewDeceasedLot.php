<div class="modal fade" id="viewDeceasedLot<?php echo $intAvailUnitId ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="z-index: 1500;display:none;">
    <div class="modal-dialog" role="document" style="width:80%; height: 90%; overflow:auto;">
        <div class="modal-content">
             <div class="modal-header" style="background:#b3ffb3;">
                ...
                <center><h3><b>LIST OF DECEASED</b></h3></center>
            </div>
            ...
            <div class='modal-body' >
                ...
                <?php 
                    ...
                    $result2 =mysql_query("SELECT * FROM tbldeceasedlot where intAvailUnitId='$intAvailUnitId'");
